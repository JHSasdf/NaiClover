...
var Post = model_1.db.LangPost;
var Follow = model_1.db.Follow;
var PostLikes = model_1.db.LangPostLike;
var Comment = model_1.db.LangComment;
var Alarm = model_1.db.Alarm;
// 전체 포스트 get요청
var getPosts = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var allPosts, myUserid, err_1, likeCountArr, PostsDatas, i, likeCount, myLikeData, followResult, isFollowing, commentCount, err_2, sortedPostDatas;
...
var createPost = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var content, userid, newPost, newPostId, newPostType, followers, _i, followers_1, element, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                newPost = _a.sent();
                newPostId = newPost.getDataValue('postId');
                newPostType = newPost.getDataValue('postType');
            ...
            case 3:
                ...
                _a.label = 4;
            case 4:
                if (!(_i < followers_1.length)) return [3 /*break*/, 7];
                element = followers_1[_i];
                return [4 /*yield*/, setAlarm(element.followerId, userid, 2, newPostId, newPostType)];
            case 5:
                _a.sent();
                _a.label = 6;
            case 6:
...
var setAlarm = function (userid, otherUserId, alarmType, option1, option2) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log('alarm check plazzzz>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>', userid, otherUserId, alarmType);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
